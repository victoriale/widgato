...
function createFriendlyIframe(){
  ...
  var style = friendlyIframe.contentWindow.document.createElement("style");
  style.appendChild(friendlyIframe.contentWindow.document.createTextNode(cssFile));
  friendlyIframe.contentWindow.document.head.appendChild(style);

  //create inline html for friendlyIframe
  friendlyIframe.contentWindow.document.write(htmlFile);

  //create inline script for friendlyIframe
  var script = friendlyIframe.contentWindow.document.createElement("script");
  script.setAttribute('type', 'text/javascript');
  script.onload = dwlinked();
  friendlyIframe.contentWindow.document.head.appendChild(script);
  // dwlinked();//start the script
}

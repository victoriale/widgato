...
$(function(){
  ...
  function dataCall(index){
  	$.get('//apirt.synapsys.us/index.php?widget=national-weathers&wid=9&skip='+index+'&limit=1', function(data){
      var curData = data.widget;
      dataLength = curData.length;
      var title = "nat-lowest-avg-temp-by-city";
      $('.fcw-t1').html('Cities in the U.S. with the Lowest Temperature');

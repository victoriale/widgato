...
$(function(){
  ...
  function dataCall(index){
  	$.get('//apirt.synapsys.us/index.php?widget=national-weathers&wid=4&skip='+index+'&limit=1', function(data){
      var curData = data.widget;
      var popData = curData[0].population;
      dataLength = curData.length;
      var title = "nat-highest-clear-day-by-city";
      $('.fcw-t1').html('Cities in the U.S. with the Most Annual Clear Days');

(function(){
  ...
  try {
    ...
    xmlHttp.open( "GET", protocol + "://w1.synapsys.us/widgets/deepdive/bar/domain_api.php?dom=" + domain, false ); // false for synchronous request
    xmlHttp.send();
  ...
  var bootstrapBoxscores = function(){
    ...
    Promise.all([promise1, promise2, promise3, promise4, promise5]).then(function(res){
      ...
      ncaamMax = processedNCAAMData.length + 1; //Plus one for category tile

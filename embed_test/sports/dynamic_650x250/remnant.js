...
(function() {
   ...
   var embedURL = protocolToUse + "://content.synapsys.us/embeds/sports/dynamic_650x250/remnant.js";
   var widgetURL = protocolToUse + "://w1.synapsys.us/widgets/dynamic_widget/dynamic_widget_970.html";
   var domain = (function() {
   ...
   var q = {
      ...
      widW: 350,  //the widget's width
      widH: 250,  //the widget's height
      adW: 300,  //the ad's width
      adH: 250,  //the ad's height
      ofx: 350,  //offset in the X direction that the ad-stack needs to be adjusted to match the designated ad-space for this widget

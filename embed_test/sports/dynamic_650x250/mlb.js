...
(function() {
   ...
   var embedURL = protocolToUse + "://content.synapsys.us/embeds/sports/dynamic_650x250/mlb.js";
   ...
   var q = {
      ...
      cat: "mlb",  //category for the dynamic widget
      type: "dynamic_mlb",  //the widget's type

var centipede = function() {
    ...
    slider.addEventListener("touchend", onFingerUp, passiveSupported ? {
        passive: true
    } : false);
    ...
    slider.addEventListener("touchstart", onFingerDown, passiveSupported ? {
        passive: true
    } : false);
    ...
    var initialMouseX;
    slider.addEventListener("mousedown", onMouseDown, passiveSupported ? {
        passive: true
    } : false);

    function onMouseDown(e) {
        initialMouseX = e.clientX;
        slider.addEventListener("mousemove", onMouseMove, passiveSupported ? {
            passive: true
        } : false);
    }
    ...
    slider.addEventListener("mouseup", onMouseUp, passiveSupported ? {
        passive: true
    } : false);

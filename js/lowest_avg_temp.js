...
$(function(){
  ...
  function dataCall(index){
  	$.get('//devapirt.synapsys.us/index.php?widget=weathers&wid=9&city='+city+'&state='+state+'&skip='+index+'&limit=1', function(data){
      if(data.widget == null){
        document.location.href = 'nat_lowest_avg_temp.html'+redirectquery;
      ...
      var title = "lowest-avg-temp-by-city";
      $('.fcw-t1').html(fullstate(curData[0].WeatherState) + ' Cities with the Lowest Temperature');

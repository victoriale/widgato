...
$(function(){
  ...
  function dataCall(index){
  	$.get('//devapirt.synapsys.us/index.php?widget=national-weathers&wid=4&city='+city+'&state='+state+'&skip='+index+'&limit=1', function(data){
      var link = "http://www.joyfulhome.com/";
      var link_partner = "http://www.myhousekit.com/";
      var curData = data.widget;
      var popData = curData[0].population;
      dataLength = curData.length;
      var title = "nat-highest-clear-day-by-city";
      $('.fcw-t1').html('Cities with the Most Clear Days Annually in the U.S.');
      ...
      if(curData[0].WeatherClearDay == 1){
        $('.fcw-content1').html(curData[0].WeatherClearDay + ' Day');
      } else {
      ...
      if(remnant == 'true' || remnant == true){
        $('.fcw-href').attr('href',link+title+"/"+curData[0].WeatherState+"/"+curData[0].WeatherCity+"/national/weather");
        ...
        $('.fcw-href').attr('href',link_partner+domain+"/national/weather/"+title+"/"+curData[0].WeatherState+"/"+curData[0].WeatherCity);

...
$(function(){
  ...
  function dataCall(index){
  	$.get('//devapirt.synapsys.us/index.php?widget=national-weathers&wid=11&city='+city+'&state='+state+'&skip='+index+'&limit=1', function(data){
      ...
      $('.fcw-t1').html('Cities with Lowest Clear Days Annually in the U.S.');
      ...
      if(curData[0].WeatherYear == null || curData[0].WeatherYear == 0 || typeof curData[0].WeatherYear == 'undefined'){

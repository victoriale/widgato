...
$(function(){
  ...
  function dataCall(index){
  	$.get('http://apirt.synapsys.us/index.php?widget=weathers&wid=12&city='+city+'&state='+state+'&city-list=1&page-list=1&skip='+index+'&limit=1', function(data){
      ...
      $('.fcw-t1').html('Cities with the Lowest Average Cloudy Days Annually')

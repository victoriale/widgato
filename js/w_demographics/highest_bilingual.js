...
$(function(){
  ...
  function dataCall(index){
  	$.get('//apirt.synapsys.us/index.php?widget=demographics&wid=3&city='+city+'&state='+state+'&skip='+index+'&limit=1', function(data){
      if(data.widget == null){
        document.location.href = 'nat_highest_bilingual.html'+redirectquery;

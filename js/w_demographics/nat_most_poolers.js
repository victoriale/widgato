...
$(function(){
  ...
  function dataCall(index){
  	$.get('//apirt.synapsys.us/index.php?widget=national-demographics&wid=9&skip='+index+'&limit=1', function(data){
      var curData = data.widget;
      var popData = curData[0].population;
      dataLength = curData.length;
      var title = "nat-most-car-poolers";
      $('.fcw-t1').html('Cities in the U.S. with the Most Carpoolers');

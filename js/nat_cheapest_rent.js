...
$(function(){
  ...
  function dataCall(index){
  	$.get('//devapirt.synapsys.us/index.php?widget=national-demographics&wid=1&city='+city+'&state='+state+'&skip='+index+'&limit=1', function(data){
      var link = "http://www.joyfulhome.com/";
      var link_partner = "http://www.myhousekit.com/";
      var curData = data.widget;
      dataLength = curData.length;
      var title = "nat-cheapest-rent";
      $('.fcw-t1').html('Cities with the Cheapest Average Rent in the U.S.');

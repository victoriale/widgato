...
$(function(){
  ...
  function dataCall(index){
  	$.get('//devapirt.synapsys.us/index.php?widget=weathers&wid=2&city='+city+'&state='+state+'&skip='+index+'&limit=1', function(data){
      if(data.widget == null){
        document.location.href = 'nat_highest_avg_temp.html'+redirectquery;
      ...
      $('.fcw-t1').html(curData[0].WeatherState + ' Cities with the Highest Average Temperature');

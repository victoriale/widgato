...
$(function(){
  ...
  function dataCall(index){
  	$.get('http://apirt.synapsys.us/index.php?widget=weathers&wid=8&city='+city+'&state='+state+'&city-list=1&page-list=1&skip='+index+'&limit=1', function(data){
      var link = "http://www.joyfulhome.com/";
      var link_partner = "http://www.myhousekit.com/";
      var curData = data.widget;
      dataLength = curData.length;
      var title = "lowest-avg-perc-by-city";
      $('.fcw-t1').html('Cities with the Lowest Average Percipitation Annually')
      $('.fcw-t2-loc').html(curData[0].WeatherCity+', '+curData[0].WeatherState);
      $('.fcw-img2').html('#'+(index+1));
      $('.fcw-content1').html(dNumberToCommaNumber(curData[0].WeatherPercipitation)+' Inches');

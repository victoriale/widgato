...
$(function(){
  ...
  function dataCall(index){
  	$.get('//apirt.synapsys.us/index.php?widget=national-weathers&wid=4&city='+city+'&state='+state+'&skip='+index+'&limit=1', function(data){
      ...
      if(remnant == 'true' || remnant == true){
        $('.fcw-href').attr('href',link+title+"/"+curData[0].WeatherState+"/"+curData[0].WeatherCity+"/national/weathers");
        ...
        $('.fcw-href').attr('href',link_partner+domain+"/national/weathers/"+title+"/"+curData[0].WeatherState+"/"+curData[0].WeatherCity);

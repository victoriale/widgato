...
$(function(){
  ...
  function dataCall(index){
  	$.get('//apirt.synapsys.us/index.php?widget=national-weathers&wid=12&skip='+index+'&limit=1', function(data){
      var curData = data.widget;
      dataLength = curData.length;
      var title = "nat-lowest-cloudy-day-by-city";
      $('.fcw-t1').html('Cities  in the U.S. with the Least Cloudy Days Annually');

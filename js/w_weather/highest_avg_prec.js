...
$(function(){
  ...
  function dataCall(index){
  	$.get('//apirt.synapsys.us/index.php?widget=weathers&wid=1&city='+city+'&state='+state+'&skip='+index+'&limit=1', function(data){
      if(data.widget == null){
      ...
      $('.fcw-t1').html(curData[0].WeatherState + ' Cities with the Most Annual Precipitation');

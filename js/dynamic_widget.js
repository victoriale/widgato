dynamic_widget = function() {
    ...
    function t() {
        "lasvegasnow.com" == u.dom && (f = !0, y = "finance.lasvegasnow.com"), ("undefined" == typeof u.category || -1 == w.indexOf(u.category)) && (u.category = "finance");
        var i, l = "undefined" != typeof u.rand && 0 == p ? u.rand : Math.floor(10 * Math.random());
        i = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), i.onreadystatechange = function() {
            if (i.readyState == XMLHttpRequest.DONE)
                if (200 == i.status) m = JSON.parse(i.responseText), e(r);
                else {
                    var l = i.statusText;
                    if (500 == i.status) try {
                    ...
                    if (l = "HTTP Error (" + i.status + "): " + l, p++ > 10) throw l;
                    setTimeout(t, 500)
                }
        }, i.open("GET", o + "?partner=" + ("undefined" != typeof u.dom ? u.dom : "") + "&cat=" + u.category + "&rand=" + l, !0), i.send()
    }
    ...
    function r() {
        ...
        if ("politics" == u.category) {
            var r = -1 != m.l_title.indexOf("Republican") ? "r" : -1 != m.l_title.indexOf("Independent") ? "i" : "d";
            add_css_link("../css/dynamic_widget_politics_" + r + ".css")
        }
        $("title").innerHTML = m.l_title, null != $("line4") && 350 == d.getElementsByClassName("dw")[0].clientWidth && $("title").scrollHeight > 61 && $("title").setAttribute("style", "font-size: 14px");
        var l = !0;
        switch (u.category) {
            case "nba":
    ...
    function i() {
        ...
        if (t.setAttribute("onerror", ""), t.setAttribute("src", ""), t.setAttribute("src", e.li_img), setTimeout(function(e, t) {
            ...
            f && (i = i.replace("www.myinvestkit.com", y));
            var l = $("subimg"),
        ...
        if ($("list-link")) {
            var s = d.getElementsByClassName("dw-btn")[0];
            s.offsetTop + s.scrollHeight > d.getElementsByClassName("dw")[0].clientHeight && ($("title").setAttribute("style", "font-size: 14px"), d.getElementsByClassName("dw")[0].clientHeight <= 250 && $("title").setAttribute("style", "font-size: 12px")), s.offsetTop + s.scrollHeight > d.getElementsByClassName("dw")[0].clientHeight - 10 && d.getElementsByClassName("dw")[0].clientHeight <= 250 && d.getElementsByClassName("dw-btn")[0].setAttribute("style", "margin-top: 0")
        }
        var a = $("title");
        a.offsetTop + a.scrollHeight > $("carousel").offsetTop && $("title").setAttribute("style", "font-size: 14px")
    }

    function l(e) {
        c += e, c = c >= m.l_data.length ? 0 : 0 > c ? m.l_data.length - 1 : c, i(), "undefined" != typeof dataLayer && dataLayer.push({
    ...
    function n() {
        return u.dom + ":" + u.category + ":" + (null == m.l_sort ? m.l_param : m.l_sort) + ":" + m.l_title
    }
    ...
    var a = "https:" == location.protocol ? "https" : "http",
        o = a + "://dw.synapsys.us/list_api.php",
        c = 0,
        m = {},
        u = JSON.parse(decodeURIComponent(location.search.substr(1))),
        p = 0,
        w = ["finance", "nba", "college_basketball", "weather", "crime", "demographics", "politics", "disaster", "mlb"],
        f = !1,
        y = "";
    return t(), e(s), {
        carousel: l,

...
$(function(){
  ...
  function dataCall(index){
  	$.get('http://devapirt.synapsys.us/index.ph?widget=demographics&wid=11&city='+city+'&state='+state+'&city-list=1&page-list=1&skip='+index+'&limit=1', function(data){
      ...
      $('.fcw-content1').html(curData[0].DemoSmartest + '% of Residents');

...
$(function(){
  ...
  function dataCall(index){
  	$.get('http://apirt.synapsys.us/index.php?widget=demographics&wid=11&city='+city+'&state='+state+'&city-list=1&page-list=1&skip='+index+'&limit=1', function(data){
      ...
      $('.fcw-t1').html('Cities with Highest Education');
      $('.fcw-t2-loc').html(curData[0].DemoCity+', '+curData[0].DemoState);
      $('.fcw-img2').html('#'+(index+1));
      $('.fcw-content1').html(dNumberToCommaNumber(curData[0].DemoSmartest) + '% of Residents');

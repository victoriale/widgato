...
$(function(){
  ...
  function dataCall(index){
  	$.get('http://apirt.synapsys.us/index.php?widget=demographics&wid=5&city='+city+'&state='+state+'&city-list=1&page-list=1&skip='+index+'&limit=1', function(data){
      ...
      $('.fcw-content1').html(curData[0].DemoHomeValue + '% of Residents');
      $('.fcw-content2').html('Make over $100,000');

...
$(function(){
  ...
  if(temp != null){
    ...
    //will need to change when api is available
  ...
  function dataCall(index){
      ...
      $('.fcw-t1').html('Top players with the highest [Baseball Data Point] for the [YYYY] season.');
      $('#title_link').html('[Player Name]');
      $('#teamProf').html('[Team Name]');
      $('#locName').html('[Location Name]');

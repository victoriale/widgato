...
$(function(){
  ...
  function dataCall(index){
  	$.get('http://apirt.synapsys.us/index.php?widget=weathers&wid=13&city='+city+'&state='+state+'&city-list=1&page-list=1&skip='+index+'&limit=1', function(data){
      var link = "http://www.joyfulhome.com/";
      var link_partner = "http://www.myhousekit.com/";
      var curData = data.widget;
      dataLength = curData.length;
      var title = "lowest-snow-fall-by-city";
      $('.fcw-t1').html('Cities with the Lowest Average Snow Fall Annually')

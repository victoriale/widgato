...
$(function(){
  ...
  function dataCall(index){
  	$.get('//devapirt.synapsys.us/index.php?widget=demographics&wid=13&city='+city+'&state='+state+'&skip='+index+'&limit=1', function(data){
      ...
      $('.fcw-content2').html('Median Age Amongst Residents');
